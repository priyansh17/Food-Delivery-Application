...
import com.priyansh.foodapp.activity.util.ConnectionManager
import com.priyansh.foodapp.R
import com.priyansh.foodapp.activity.adapter.OrderHistoryAdapter
import com.priyansh.foodapp.activity.model.OrderHistoryRestaurant
...
class OrderHistoryActivity : AppCompatActivity() {
            ...
            try {
                ...
                val jsonObjectRequest = object : JsonObjectRequest(
                    ...
                    Response.Listener {
                        ...
                        println("Response of order history is " + it)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when(id){
            android.R.id.home->{
                val intent = Intent(this@OrderHistoryActivity,
